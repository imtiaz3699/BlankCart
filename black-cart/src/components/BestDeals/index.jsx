...
function BestDeals() {
  ...
  return (
    <div className='w-full flex flex-col gap-[24px]'>
      ...
      <div className='flex flex-row items-start border-[1px] border-[#E4E7E9]'>
        <div className=' flex flex-col gap-[24px] p-[24px] border-r-[1px] border-[#E4E7E9] max-w-[328px] w-full'  >
          <div className='h-[268px] relative '>
            <img src='/Image1.png' className='w-full h-full' />
